...
const Footer = () => {
  return (
    <footer className="pt-5 pb-3 mt-5" style={{ backgroundColor: "#8B0000", color: "#FFD700" }}>
      <Container>
        <Row className="mb-4">
          <Col md={4} className="mb-3">
            <h5 className="fw-bold">Restaurant Management</h5>
            <p>Chúng tôi mang đến trải nghiệm ẩm thực tuyệt vời với không gian sang trọng và dịch vụ tận tâm.</p>
          </Col>
